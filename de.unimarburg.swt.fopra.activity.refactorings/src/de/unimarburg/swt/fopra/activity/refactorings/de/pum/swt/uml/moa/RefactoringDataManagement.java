...
public class RefactoringDataManagement extends DataManagementAdapter {
	...
	private void addPorts(){
		this.inPorts.add
			(new Port<org.eclipse.uml2.uml.ControlFlow>
				(SELECTEDEOBJECT, org.eclipse.uml2.uml.ControlFlow.class));
		this.inPorts.add
			(new Port<String>
	...
	public void preselect(List<EObject> selection) {
		getInPortByName(SELECTEDEOBJECT).
				setValue((org.eclipse.uml2.uml.ControlFlow) selection.get(0));
	}
